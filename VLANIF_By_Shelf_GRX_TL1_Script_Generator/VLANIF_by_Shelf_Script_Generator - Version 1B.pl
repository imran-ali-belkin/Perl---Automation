...
print "\n\n";
print "========================================================\n";
print "Enter the Shelf that you want the VLANIFs created for.\n";
print "For example, if you are planning to remove shelf N2-1 and need\n";
print "just the VLANIFs for that shelf then enter N2-1:\n";
print ">";
my $user_shelf = <STDIN>;
chomp($user_shelf);
