...
#
print "========================================================\n";
print "The IPVC xDSL By Shelf Script Generator\n";
...
print "1: Logs into a C7 and pulls IPVC xDSL info\n";
...
#
print "=================================================================\n";
print "Results of IPVC By Shelf xDSL Script Generator:\n";


print "Candidate xcon found:\t $candidate_found\n";
print "IPVC xcon written to CREATES:\t $candidate_create\n";
print "IPVC xcon written to DELETES:\t $candidate_delete\n";
