...
print "\n\n\n\n\n\n";
print "=================================================================\n";
print "The ADSL and T0 Port Script Creator\n";
print "=================================================================\n";
print "\n\n";
print "This script does these three things:\n";
print "1: Logs into a C7 and pulls DSL and T0 port info on a single slot\n";
...
print "\n";
print "=================================================================\n";
print "Enter the ADSL card node-shelf-slot you want me to retrieve on:\n"; 
...
print "\n";
print "=================================================================\n";
print "Enter the DSL node-shelf-slot that the new card will reside in:\n";
...
print "==========================================================\n";
print "I am retrieving all of the ADSL ports on DSL card: $user_ADSL_Slot \n";  
print "==========================================================\n";
...
print "\n==========================================================\n";
print "I am retrieving all of the T0 ports on the DSL card: $user_ADSL_Slot \n";  
