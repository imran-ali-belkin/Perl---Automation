...
print "\n\n\n\n\n\n";
print "========================================================\n";
print "The C7 VLANIF EXA to VLANIF EXA Script Creator\n";
print "========================================================\n";
print "\n\n";
	...
	if ($network_software_version eq '7.0' || $network_software_version eq '7.2') 
	{
		...
		{					
						...
						{	
							...
							print {$fh_creates} ("ENT-VLAN-IF::$1::::VLAN=$user_future_data_vlan,BRIDGE=LOCAL,ARP=$4,DHCPDIR=$5,PPPOESUB=$9,DIRN=$16,PORTTYPE=$18,RXETHBWPROF=$23,TXETHBWPROF=$24,CVID=$19,PRIO=$21,RCVID=$22,PATH=UNPROT;\n"); 
							$ont_creates++;
